        ...
        implements ParquetHandler
{
    ...
    private CloseableIterator<FileDataReadResult> readFiles(CloseableIterator<FileReadContext> fileIter, StructType physicalSchema)
    {
        ...
        {
            private FileReadContext currentFileReadContext;
            ...
            public boolean hasNext()
            {
                ...
                TrinoInputFile inputFile = fileSystem.newInputFile(new Path(URI.create(fileStatus.getPath())).toString());
            ...
            implements CloseableIterator<ColumnarBatch>
    {
        ...
        public ColumnarBatch next()
        {
            ...
            nextPage = null;
            return new TrinoDeltaColumnarBatch(schema, page);
        }
