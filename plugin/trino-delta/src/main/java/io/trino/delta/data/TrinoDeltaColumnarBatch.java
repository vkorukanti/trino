        ...
        implements ColumnarBatch
{
    ...
    public TrinoDeltaColumnarBatch(StructType schema, Page page)
    {
    ...
    {
        return new TrinoDeltaColumnarBatch(newSchema, page);
    }
    ...
    {
        return new TrinoDeltaColumnVector(deltaType, block);
    }
}
