...
public class TestDeltaTableHandle
{
    ...
    public void testJsonRoundTrip()
    {
        List<DeltaColumn> columns = ImmutableList.of(
                new DeltaColumn("c1", REAL.getTypeSignature(), true),
                new DeltaColumn("c2", INTEGER.getTypeSignature(), false),
                new DeltaColumn("c3", DOUBLE.getTypeSignature(), false),
                new DeltaColumn("c4", DATE.getTypeSignature(), true));
