...
public class TestPinotConfig
{
    ...
    public void testDefaults()
    {
        ConfigAssertions.assertRecordedDefaults(ConfigAssertions.recordDefaults(PinotConfig.class)
                ...
                .setProxyRestUrl(null)
                .setProxyRestService(null)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("proxy-rest-url", "localhost:5436")
                .put("proxy-rest-service", "upinot-rest-proxy-staging")
                .put("idle-timeout", "1h")
        ...
        PinotConfig expected = new PinotConfig()
                ...
                .setProxyRestUrl("localhost:5436")
                .setProxyRestService("upinot-rest-proxy-staging")
